...
@pytest.mark.parametrize(
    ...
    [
        ("accept", IdeaProcessingStatus.COMPLETED.value),
...
def test_retry_rejects_non_failed_and_exhausted_ideas(
    ...
    idea.duplicate_method = None
    idea.ai_duplicate_verdict = None
    idea.effective_duplicate_verdict = None
    idea.duplicate_confidence = None
    idea.matched_idea_id = None
    idea.duplicate_reason = None
    idea.duplicate_comparison = None
